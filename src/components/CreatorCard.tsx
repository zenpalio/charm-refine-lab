...
const CreatorCard = ({ name, avatarUrl, verified = false }: CreatorCardProps) => {
  return (
    <div className="flex-shrink-0 flex items-center gap-4 bg-card rounded-2xl px-5 py-4 min-w-[240px] cursor-pointer hover:bg-card/80 transition-colors group">
