    ...
    <div className="flex flex-col items-center gap-2 cursor-pointer" onClick={onClick}>
      ...
      >
        ...
        {equipped ? (
          ...
          <div className="absolute -top-1.5 -right-1.5 z-20 text-[9px] font-bold px-2 py-0.5 rounded-full border border-border/30" style={{ backgroundColor: "hsl(142 76% 36% / 0.15)", color: "hsl(142 76% 36%)" }}>
