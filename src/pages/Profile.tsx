...
const badgeCategories = [
  {
    ...
    badges: [
      { name: "Newbie", aura: 10, tier: "newbie" as const, unlocked: true, claimed: true },
      { name: "Master", aura: 20, tier: "master" as const, unlocked: true, claimed: true },
      { name: "Legend", aura: 40, tier: "legend" as const, unlocked: true, claimed: true },
      { name: "Elite", aura: 80, tier: "elite" as const, unlocked: true, claimed: false },
      { name: "Mythic", aura: 150, tier: "mythic" as const, unlocked: true, claimed: true },
      { name: "Grandmaster", aura: 300, tier: "grandmaster" as const, unlocked: true, claimed: true },
      { name: "Immortal", aura: 500, tier: "immortal" as const, unlocked: true, claimed: true },
    ],
  },
  {
    title: "Characters",
    ...
    badges: [
      { name: "Newbie", aura: 1, tier: "newbie" as const, unlocked: true },
      { name: "Master", aura: 5, tier: "master" as const, unlocked: true },
      { name: "Legend", aura: 10, tier: "legend" as const, unlocked: true },
      { name: "Elite", aura: 20, tier: "elite" as const, unlocked: true },
      { name: "Grandmaster", aura: 30, tier: "grandmaster" as const, unlocked: true },
      { name: "Mythic", aura: 50, tier: "mythic" as const, unlocked: true },
      { name: "Immortal", aura: 100, tier: "immortal" as const, unlocked: true },
    ],
  },
  {
    title: "Social",
    ...
    badges: [
      { name: "Newbie", aura: 1, tier: "newbie" as const, unlocked: true },
      { name: "Master", aura: 5, tier: "master" as const, unlocked: false },
      { name: "Legend", aura: 10, tier: "legend" as const, unlocked: false },
      { name: "Elite", aura: 20, tier: "elite" as const, unlocked: false },
      { name: "Grandmaster", aura: 30, tier: "grandmaster" as const, unlocked: false },
      { name: "Mythic", aura: 50, tier: "mythic" as const, unlocked: false },
      { name: "Immortal", aura: 100, tier: "immortal" as const, unlocked: false },
    ],
  },
  {
    title: "Messaging",
  ...
  },
  {
    ...
    badges: [
      { name: "Newbie", aura: 1, tier: "newbie" as const, unlocked: true },
      { name: "Master", aura: 5, tier: "master" as const, unlocked: true, isNew: true },
      { name: "Legend", aura: 10, tier: "legend" as const, unlocked: false },
      { name: "Elite", aura: 20, tier: "elite" as const, unlocked: false },
      { name: "Grandmaster", aura: 30, tier: "grandmaster" as const, unlocked: false },
      { name: "Mythic", aura: 50, tier: "mythic" as const, unlocked: false },
