...
const badgeCategories = [
  {
    ...
    badges: [
      ...
      { name: "Obsession", aura: 3000, tokens: 300, tier: "grandmaster" as const, unlocked: true, claimed: true },
  ...
  },
  {
    ...
    badges: [
      ...
      { name: "Goddess", aura: 300, tokens: 30, tier: "grandmaster" as const, unlocked: true },
  ...
  },
  {
    ...
    badges: [
      ...
      { name: "Icon", aura: 300, tokens: 30, tier: "grandmaster" as const, unlocked: false },
  ...
  },
  {
    ...
    badges: [
      ...
      { name: "Legend", aura: 100, tokens: 10, tier: "legend" as const, unlocked: false },
      { name: "Elite", aura: 200, tokens: 20, tier: "elite" as const, unlocked: false },
      { name: "Seducer", aura: 300, tokens: 30, tier: "grandmaster" as const, unlocked: false },
      { name: "Mythic", aura: 500, tokens: 50, tier: "mythic" as const, unlocked: false },
      { name: "Immortal", aura: 1000, tokens: 100, tier: "immortal" as const, unlocked: false },
    ],
  },
  {
    ...
    badges: [
      ...
      { name: "Legend", aura: 100, tokens: 10, tier: "legend" as const, unlocked: false },
      { name: "Elite", aura: 200, tokens: 20, tier: "elite" as const, unlocked: false },
      { name: "Muse", aura: 300, tokens: 30, tier: "grandmaster" as const, unlocked: false },
      { name: "Mythic", aura: 500, tokens: 50, tier: "mythic" as const, unlocked: false },
      { name: "Immortal", aura: 1000, tokens: 100, tier: "immortal" as const, unlocked: false },
    ],
  },
